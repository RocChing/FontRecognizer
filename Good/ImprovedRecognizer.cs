...
namespace Good
{
    ...
    public class ImprovedRecognizer : ICharactorRecognizer
    {
        ...
        {
            return System.Reflection.Assembly.LoadFrom("Libs\\"+assembly+".dll").CreateInstance(fullName, false);
        }
        private Type ReflectGetType(string assembly, string fullName)
        {
            return System.Reflection.Assembly.LoadFrom("Libs\\" + assembly + ".dll").GetType(fullName, false);
        }
    }
}
